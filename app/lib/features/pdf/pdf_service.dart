...
class PdfService {
  /// Gibt pro Komponente (BMK) immer die neueste Messung zurück.
  ///
  /// Das Prüfdatum ist im PDF-Header sichtbar, daher spielt es keine Rolle ob
  /// die Messung bereits in einem früheren Protokoll enthalten war.
  static List<Messung> filterMessungenForProtokoll(List<Messung> messungen) {
