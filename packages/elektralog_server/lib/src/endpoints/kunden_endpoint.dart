      ...
      return Response.ok(
        jsonEncode({
          ...
          'standorte': standorte.map((r) => {
            ...
            'plz': r[4],
            'ort': r[5],
            'erstelltAm': r[6].toString(),
            'aktualisiertAm': r[7].toString(),
          }).toList(),
          ...
          'sichtpruefungen': sichtpruefungen.map((r) => {
            'uuid': r[0].toString(),
            'verteilerUuid': r[1].toString(),
            'pruefungDatum': r[2].toString(),
            'prueferName': r[3],
            'checklisteJson': r[4],
            'maengel': r[5],
            'ergebnis': r[6],
            'naechstePruefungDatum': r[7]?.toString(),
            'erstelltAm': r[8].toString(),
            'aktualisiertAm': r[9].toString(),
          }).toList(),
        }),
